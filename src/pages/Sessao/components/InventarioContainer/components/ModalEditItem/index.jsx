...
export function ModalEditItem({ data, setModalClose, atualizar, itens }) {
  ...
  async function handleCreate(e) {
    ...
    try {
      ...
      const response = await api.put(`/sessoes/item/${data.id}`, {
        nome,
        espaco,
        categoria,
        descricao,
    ...
    <Container>
      ...
      <form onSubmit={handleCreate}>
        ...
        <Body>
          ...
          <Input required label={'Espaços'} type={'number'} valor={espaco} setValor={setEspaco} maxValor={99} maxLength={2} />
